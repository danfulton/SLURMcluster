...
sleep 5
sudo  /share/sched/slurm/23.11.5/bin/sacctmgr -i add account debug cluster=NDv6 && sudo sacctmgr -i add user azhpcuser account=debug
sudo  /share/sched/slurm/23.11.5/bin/sacctmgr -i add account AICE Description="AICE Testing" Organization="AICE"
sudo  /share/sched/slurm/23.11.5/bin/sacctmgr -i add user azhpcuser account=AICE
...
sudo  /share/sched/slurm/23.11.5/bin/scontrol reconfigure
