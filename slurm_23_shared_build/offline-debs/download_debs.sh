...
mkdir -p /share/offline-debs/slurm-deps

cd /share/offline-debs/slurm-deps

apt download   libaec0 libb64-0d libdbi1t64 libhdf5-103-1t64 libhdf5-hl-100t64 libhwloc-plugins libhwloc15 libipmimonitoring6 libjwt2 liblua5.1-0 libmunge2 liboam-dev liboam1 librocm-smi-dev librocm-smi64-1 librrd8t64 libsz2 munge  ocl-icd-libopencl1 libmunge-dev libmunge2 libmysqlclient21
